...
***SUMMARY*** : [struct signal_struct](https://elixir.bootlin.com/linux/v2.6.11/source/include/linux/sched.h#L274) 
...
The data structures used in the **`PID` hash tables** are quite sophisticated, because they must keep
